...
int main()
{
	...
	string i = 1;
	string j = 0;
	string id = string(s) + "_" + string(r) + "_" +  i + "_" + j;
	string name = "grid_" + id + ".txt";
	ifstream inputFile(name.c_str());
	name = "convertible_price-" + id + ".csv";
	...
	double putValue;
	inputFile >> putValue;
    double contingentHurdle;
	inputFile >> contingentHurdle;
    double callHurdle;
	inputFile >> callHurdle;
    double R_v;
	inputFile >> R_v;
